...
source to paste into your code. Drop a shell function in your `~/.zshrc` so bare `lg` opens a fuzzy
picker with a syntax-highlighted preview (via [bat](https://github.com/sharkdp/bat)), and `lg <name>`
prints the source:
